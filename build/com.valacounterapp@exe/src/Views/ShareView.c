...
_share_view_on_drag_drop_gtk_widget_drag_data_received (GtkWidget* _sender,
                                                        ...
                                                        gpointer self)
{
#line 22 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
...
_share_view_clear_link_gtk_button_clicked (GtkButton* _sender,
                                           gpointer self)
{
#line 36 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
...
share_view_construct (GType object_type)
{
	...
	GtkLabel* _tmp20_;
	GtkLabel* _tmp21_;
#line 8 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	self = (ShareView*) g_object_new (object_type, NULL);
#line 10 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	gtk_orientable_set_orientation ((GtkOrientable*) self, GTK_ORIENTATION_VERTICAL);
#line 11 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	gtk_widget_set_margin_bottom ((GtkWidget*) self, 24);
#line 12 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	gtk_widget_set_valign ((GtkWidget*) self, GTK_ALIGN_CENTER);
#line 12 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	gtk_widget_set_halign ((GtkWidget*) self, GTK_ALIGN_CENTER);
#line 14 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	gtk_grid_set_row_spacing ((GtkGrid*) self, 12);
#line 17 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
...
#line 18 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	_tmp1_ = self->priv->new_document;
#line 18 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	gtk_image_set_pixel_size (_tmp1_, 128);
#line 20 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
...
#line 24 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
...
#line 26 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
...
#line 27 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
...
#line 28 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
...
#line 29 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
...
#line 30 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	_tmp12_ = self->priv->share_link;
#line 30 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	gtk_label_set_use_underline (_tmp12_, TRUE);
#line 32 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
...
#line 33 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	_tmp14_ = self->priv->clear_button;
#line 33 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	gtk_widget_set_hexpand_set ((GtkWidget*) _tmp14_, FALSE);
#line 34 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	_tmp15_ = self->priv->clear_button;
#line 34 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	g_object_set ((GtkWidget*) _tmp15_, "expand", FALSE, NULL);
#line 35 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
...
#line 38 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	_tmp19_ = self->priv->new_document;
#line 38 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	gtk_container_add ((GtkContainer*) self, (GtkWidget*) _tmp19_);
#line 39 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	_tmp20_ = self->priv->file_name;
#line 39 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	gtk_container_add ((GtkContainer*) self, (GtkWidget*) _tmp20_);
#line 40 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
...
share_view_clear_link (ShareView* self)
{
	...
	GtkLabel* _tmp2_;
	GtkButton* _tmp3_;
#line 44 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	g_return_if_fail (self != NULL);
#line 45 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	_tmp0_ = self->priv->new_document;
#line 45 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	g_object_set (_tmp0_, "icon-name", "document-new-symbolic", NULL);
#line 46 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	_tmp1_ = self->priv->file_name;
#line 46 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	gtk_label_set_label (_tmp1_, "");
#line 47 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	_tmp2_ = self->priv->share_link;
#line 47 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	gtk_label_set_label (_tmp2_, "Generate sharelink");
#line 48 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
                         ...
                         const gchar* file_uri)
{
	...
	gchar* _tmp15_;
	gchar* _tmp16_;
#line 51 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	g_return_if_fail (self != NULL);
#line 51 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	g_return_if_fail (file_uri != NULL);
#line 52 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
...
#line 54 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	_tmp3_ = dropbox_gen_share_link (file_absolut_path);
#line 54 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	url = _tmp3_;
#line 55 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
                         ...
                         guint time)
{
	...
	GList* _tmp21_;
	gboolean _tmp22_;
#line 58 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	g_return_if_fail (self != NULL);
#line 58 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
...
#line 59 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	_tmp0_ = self->priv->new_document;
#line 59 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	g_object_set (_tmp0_, "icon-name", "image-loading-symbolic", NULL);
#line 61 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
...
#line 61 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	file = _tmp6_;
#line 63 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	_tmp7_ = self->priv->file_name;
#line 63 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	_tmp8_ = file;
#line 63 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
...
#line 63 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	_g_free0 (_tmp10_);
#line 65 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
...
#line 66 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	_tmp19_ = self->priv->new_document;
#line 66 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	g_object_set (_tmp19_, "icon-name", "process-completed", NULL);
#line 68 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
...
#line 584 "ShareView.c"
		GtkButton* _tmp23_;
		GtkButton* _tmp24_;
#line 69 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
		_tmp23_ = self->priv->clear_button;
#line 69 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
		gtk_container_add ((GtkContainer*) self, (GtkWidget*) _tmp23_);
#line 70 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
...
#line 595 "ShareView.c"
		...
		GtkButton* _tmp25_;
#line 72 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
...
#line 2 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	_g_object_unref0 (self->priv->new_document);
#line 3 "/home/rodrigo/Public/ValaCounter/src/Views/ShareView.vala"
	_g_object_unref0 (self->priv->share_link);
